...
const goToDetail = (id) => {
    router.visit(route("staff.show", { id: id, origin: "transferin.index" }));
};
...
<template>
    <Head title="ការផ្ទេរចូល | ស្នងការដ្ឋាននគរបាលខេត្តប៉ៃលិន" />
    <AuthenticatedLayout>
        <div class="py-2">
