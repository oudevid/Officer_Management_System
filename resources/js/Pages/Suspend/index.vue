...
const goToDetail = (id) => {
    router.visit(route("staff.show", { id: id, origin: "suspend.index" }));
};
...
<template>
    <Head title="ព្យួរក្របខណ្ឌ | ស្នងការដ្ឋាននគរបាលខេត្តប៉ៃលិន" />
    <AuthenticatedLayout>
        <div class="py-2">
            <div class="flex justify-between mb-8 font-siemreap mx-5">
                <div class="w-1/2 bg-white py-3.5 px-2 rounded-lg">
                    <h1 class="font-siemreap text-md font-bold">
                        បញ្ជីឈ្មោះមន្ត្រីព្យួរក្របខណ្ឌ
                    </h1>
                </div>
